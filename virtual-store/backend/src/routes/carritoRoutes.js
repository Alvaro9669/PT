...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        const user = JSON.parse(userCookie); // Obtener el usuario desde la cookie
        const discordId = user.id; // ID de Discord desde la cookie
        console.log('Discord ID from cookie:', discordId);

        // Buscar el ID_usuarios correspondiente al discord_id
        ...
        // Buscar el carrito asociado al usuario y los productos en el carrito
